import { C as useSlice, E as setState, K as require_react, N as assetUrl, U as Icon, W as require_jsx_runtime, _ as formatDuration, g as formatDayTime, x as initialOf } from "./degraded-qMnijys5.js";
import { i as Segmented, r as SearchBox } from "./controls-CacwHgpC.js";
...
function AppGrid({ apps, runningIds = [], selectedId, onPick, allowAll = true, searchKey = "grid" }) {
...
function Cell({ active, label, meta, mark, category, onPick }) {
