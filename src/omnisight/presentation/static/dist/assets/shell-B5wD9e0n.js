import { B as tokenParam, C as useSlice, E as setState, F as get, G as require_react_dom, K as require_react, L as messageOf, M as adoptToken, O as ToastHost, R as patch, U as Icon, W as require_jsx_runtime, _ as formatDuration, a as isTheme, c as set, d as TooltipHost, h as formatCount, i as THEMES, k as fail, q as __commonJSMin, s as restore, t as Banners, u as watchSystem } from "./degraded-mkfLsXii.js";
...
function Drawer({ title, children, footer, onClose = null, wide = false, headExtra }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				"aria-hidden": "true"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: LABELS[state] + (live.mode === "polling" ? "（轮询中）" : "") })]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
//#endregion
//#region frontend/src/components/ThemeMenu.tsx
/**
...
function ThemeMenu() {
	...
	(0, import_react.useEffect)(() => {
		if (!open) return;
		itemsOf(panel.current)[Math.max(0, THEMES.indexOf(theme))]?.focus();
	}, [open, theme]);
	const close = () => {
		setOpen(false);
	...
	const pick = (value) => {
		set(value);
		close();
		patch("/settings", { settings: { "ui.theme": value } }).catch((error) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			onClick: () => setOpen((value) => !value),
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { name: current.icon })
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			"aria-label": "主题",
			onKeyDown,
			children: THEMES.map((value) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				onClick: () => pick(value),
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { name: OPTIONS[value].icon }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "theme-menu__label",
						children: OPTIONS[value].label
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "theme-menu__check",
						children: value === theme ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { name: "check" }) : null
					})
				]
			}, value))
		})]
...
//#endregion
//#region frontend/src/components/Veil.tsx
function Veil() {
	const loading = useSlice("loading");
	const data = useSlice("data");
	const cold = Object.keys(loading).some((key) => loading[key] && data[key] === void 0);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "veil",
		"data-visible": cold ? "true" : void 0,
		"aria-hidden": "true",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "veil__spinner" })
	});
}
//#endregion
//#region frontend/src/pages/shell.tsx
...
*/
function PageLink({ href, icon, label, onActivate = null }) {
...
*/
function mountChrome({ nav, banners } = {}) {
	(0, import_client.createRoot)(mountPoint("banners")).render(/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react.StrictMode, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Banners, {}), banners] }));
	...
	(0, import_client.createRoot)(mountPoint("overlays")).render(/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react.StrictMode, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(OverlayHost, {}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipHost, {}),
...
function MissingToken() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "缺少访问令牌" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "muted",
			children: "请从托盘菜单重新打开仪表盘。令牌只在打开时经 URL 交接一次，同一标签页内刷新仍然有效。"
		})]
	});
}
//#endregion
export { mountChrome as a, Drawer as c, require_client as d, loadStatus as i, closeOverlay as l, PageLink as n, mountPoint as o, adopt as r, pageUrl as s, MissingToken as t, openOverlay as u };
