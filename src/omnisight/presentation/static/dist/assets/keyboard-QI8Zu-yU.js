import { C as useSlice, E as setState, G as require_react_dom, H as on, K as require_react, S as useResource, U as Icon, W as require_jsx_runtime, b as formatPercent, f as hide, h as formatCount, n as capabilityOf, o as prefersReducedMotion, p as show, r as noticeFor, w as getState } from "./degraded-mkfLsXii.js";
import { i as Segmented } from "./controls-CgVt8_vH.js";
import { a as fromISO, c as HEAT_BOUNDS, d as formatMetric, f as heatLevel, h as metricOf, i as bucketCoversGap, l as METRICS, m as isSaturated, n as METRIC_SLOT_ID, o as gapSet, p as heatRatio, r as Updated, s as periodParams, t as fetchInto, u as TIMELINE_VIEWS } from "./main-BMUberad.js";
import { n as Section, t as Card } from "./Card-CxjL8c3d.js";
import { i as Mark, n as AppGrid, t as Quad } from "./Quad-BFRR8NaA.js";
import { a as SkeletonRows, i as GapLegend, n as EmptyState, r as ErrorState, t as CapabilityNotice } from "./states-WQyaTbLh.js";
import { a as bar, c as niceMax, i as Chart, n as hideChartTooltip, o as cssFont, r as showChartTooltip, s as hatchPattern, t as drawTimeAxis } from "./axis-B3WMBRfR.js";
...
//#endregion
//#region frontend/src/components/HeatStrip.tsx
/**
...
function HeatStrip({ buckets, scale, valueLabel, format, label }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: buckets.map((bucket, index) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "heatstrip__slot",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "heat-cell",
					"data-level": heatLevel(ratio),
					"data-gap": bucket.gap ? "true" : void 0,
					"aria-label": bucket.gap ? `${title}：无记录` : `${title}：${format(bucket.value)}`,
					onPointerMove: (event) => show({
						title,
						rows: [[valueLabel, bucket.gap ? "无记录" : format(bucket.value)]],
						note: bucket.gap ? "这一段没有采集覆盖" : void 0,
						x: event.clientX,
						y: event.clientY
					}),
					onPointerLeave: hide
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "heatstrip__label",
					children: index % step === 0 ? title : ""
				})]
			}, bucket.bucket);
		})
	});
...
function View() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "card",
				children: shownForm === "heat" ? grain === "days" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Calendar, {}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeatScale, { grain }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScaleBars, { grain })
			})
		}),
...
function HeatScale({ grain }) {
	...
	if (!view || view.available === false) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TimelineUnavailable, { payload });
	const gaps = gapSet(coverage, ["keyboard"]);
	const definition = metricOf(metric);
	const marked = markGaps(view.buckets, GAP_GRAIN[grain], gaps, view.period);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeatStrip, {
...
function TimelineUnavailable({ payload }) {
