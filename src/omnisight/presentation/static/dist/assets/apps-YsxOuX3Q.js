import { A as ok, C as useSlice, E as setState, F as get, G as require_react_dom, K as require_react, L as messageOf, N as assetUrl, P as del, R as patch, S as useResource, U as Icon, V as emit, W as require_jsx_runtime, _ as formatDuration, b as formatPercent, h as formatCount, k as fail, n as capabilityOf, o as prefersReducedMotion, r as noticeFor, w as getState, x as initialOf, z as post } from "./degraded-mkfLsXii.js";
import { a as Switch, i as Segmented, n as Chip, r as SearchBox, t as Checkbox } from "./controls-CgVt8_vH.js";
import { r as Updated, s as periodParams, t as fetchInto } from "./main-BMUberad.js";
import { n as Section, t as Card } from "./Card-CxjL8c3d.js";
import { n as AppGrid, r as BigMark, t as Quad } from "./Quad-BFRR8NaA.js";
import { a as SkeletonRows, n as EmptyState, r as ErrorState, t as CapabilityNotice } from "./states-WQyaTbLh.js";
...
//#endregion
//#region frontend/src/components/ContextMenu.tsx
...
function ContextMenu({ state, onClose }) {
	...
	return (0, import_react_dom.createPortal)(/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [state.title ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "context-menu__title",
			children: state.title
		}) : null, state.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [item.icon ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { name: item.icon }) : null, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
*/
function excludeApp(app, excluded) {
	(async () => {
		try {
...
function banProcess(app) {
	...
	(async () => {
		try {
			const field = (await get("/settings")).settings["privacy.excluded_processes"];
