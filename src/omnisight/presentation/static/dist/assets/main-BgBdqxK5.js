const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/overview-BYWlsM4v.js","assets/degraded-qMnijys5.js","assets/Card-CwX6lTXj.js","assets/states-BInd1nRj.js","assets/apps-CGks4WV6.js","assets/controls-CacwHgpC.js","assets/shell-8ge_e5M8.js","assets/Quad-1An0_H8C.js","assets/keyboard-CjK-Hsor.js","assets/axis-J_X4OlX3.js","assets/insights-De0n-EFR.js","assets/SettingsDrawer-C-p9mpcQ.js","assets/SettingsPage-C_ET1OP0.js"])))=>i.map(i=>d[i]);
import { B as tokenParam, C as useSlice, D as subscribe, E as setState, F as get, H as on, I as invalidate, K as require_react, T as setEntry, U as Icon, V as emit, W as require_jsx_runtime, c as set, f as hide, h as formatCount, j as ApiError, k as fail, l as setHeat, m as formatClock, p as show, w as getState, y as formatMs, z as post } from "./degraded-qMnijys5.js";
import { a as mountChrome, d as require_client, i as loadStatus, l as closeOverlay, n as PageLink, o as mountPoint, r as adopt, t as MissingToken, u as openOverlay } from "./shell-8ge_e5M8.js";
import { i as Segmented, o as ImportBanner, s as openImportWizard } from "./controls-CacwHgpC.js";
import { t as AboutContent } from "./AboutContent-DWlW-QB_.js";
...
var VIEW_MODULES = {
	overview: () => __vitePreload(() => import("./overview-BYWlsM4v.js"), __vite__mapDeps([0,1,2,3])),
	apps: () => __vitePreload(() => import("./apps-CGks4WV6.js"), __vite__mapDeps([4,1,5,6,2,7,3])),
	keyboard: () => __vitePreload(() => import("./keyboard-CjK-Hsor.js"), __vite__mapDeps([8,1,5,6,2,7,3,9])),
	insights: () => __vitePreload(() => import("./insights-De0n-EFR.js"), __vite__mapDeps([10,1,2,3,9]))
};
var viewRoot = null;
...
function openSettings() {
	__vitePreload(() => import("./SettingsDrawer-C-p9mpcQ.js").then((module) => module.openSettingsDrawer()), __vite__mapDeps([11,1,6,12,5,2])).catch(() => fail("设置面板加载失败，请刷新页面"));
}
async function main() {
	const token = adopt();
	mountShell();
