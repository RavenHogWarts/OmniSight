...
| 面板 | 内容                                                                                  |
| ---- | ------------------------------------------------------------------------------------- |
| 总览 | 屏幕时间、按键总量、按类别分层的活动带、「这段时间算不算多」的对照条、应用排行、自动生成的要点 |
| 应用 | 应用列表与详情、会话时间线、按时长 / 按键 / 次数 / 名称 / 最近使用排序、别名 / 分类 / 合并 / 排除 |
| 键盘 | 全键盘热力图（次数 / 平均时长 / 最长时长）、按小时 / 天 / 月 / 年的分布与日历、单键详情、人体工学分布 |
| 洞察 | 应用×键热力图、每小时用了哪些应用、某个键主要被哪些应用使用、输入节奏与屏幕时间的对比 |
